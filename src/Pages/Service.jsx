...
const ServiceCard = ({ title, description, image, icon }) => {
  ...
  return (
    <div className="group relative h-[420px] w-full overflow-hidden rounded-[28px] bg-white shadow-sm ring-1 ring-black/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="absolute right-6 top-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#7ED957] shadow-md">
      ...
      <div className="absolute left-6 right-6 bottom-6 rounded-[22px] bg-white px-6 py-4 text-left shadow-lg transition-all duration-300 ease-out group-hover:bottom-8">
        ...
        <div className="mt-3">
          <button
            type="button"
            className="rounded-full bg-[#7ED957] px-5 py-2 text-sm font-semibold text-green-950 opacity-0 translate-y-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0 hover:brightness-95"
          >
            Read More
          </button>
        </div>
    ...
    <section className="bg-[#F4F6F3] py-16">
      <div className="mx-auto max-w-6xl px-4 text-center">
        ...
        <div className="relative mt-12">
          <button
            onClick={prev}
            className="absolute -left-4 top-1/2 z-10 hidden -translate-y-1/2 rounded-full bg-white p-3 shadow-md ring-1 ring-black/5 transition hover:shadow-lg lg:block"
          >
